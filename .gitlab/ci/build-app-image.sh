...
APP_IMAGE_REGISTRY_PASSWORD="${APP_IMAGE_REGISTRY_PASSWORD:-}"

: "${APP_IMAGE_REGISTRY_USERNAME:?APP_IMAGE_REGISTRY_USERNAME is required}"
: "${APP_IMAGE_REGISTRY_PASSWORD:?APP_IMAGE_REGISTRY_PASSWORD is required}"
